...
NUM_WORKERS=8
SAVE_EVERY=5
LOSS_WEIGHTS='{"canvas_mse": 1.0, "merge": 2.0,"stroke_length": 0.1, "sinuosity": 0.01, "smoothness": 0.001, "width_smooth": 0.01, "hires_mse": 1.0, "overlap": 0.3, "parallel": 1.0, "exist_bce": 0.1, "exist_target": 4}'
