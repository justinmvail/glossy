...
# Backward compatibility: OCRValidator moved to ocr_validator.py
from ocr_validator import OCRValidator  # noqa: E402, F401
...
# Backward compatibility: CLI moved to inksight_cli.py
def main() -> None:
    """Entry point for CLI (deprecated - use inksight_cli.py directly)."""
    from inksight_cli import main as cli_main
    cli_main()
